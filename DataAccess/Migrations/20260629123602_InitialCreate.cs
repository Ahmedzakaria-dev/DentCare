...
namespace DataAccess.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AppointmentTeeth",
                columns: table => new
                {
                    AppointmentToothId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppointmentId = table.Column<int>(type: "int", nullable: false),
                    ToothId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentTeeth", x => x.AppointmentToothId);
                    table.ForeignKey(
                        name: "FK_AppointmentTeeth_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "AppointmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentTeeth_Teeth_ToothId",
                        column: x => x.ToothId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppointmentTreatmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppointmentId = table.Column<int>(type: "int", nullable: false),
                    TreatmentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentTreatments", x => x.AppointmentTreatmentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentTeeth_AppointmentId",
                table: "AppointmentTeeth",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentTeeth_ToothId",
                table: "AppointmentTeeth",
                column: "ToothId");
